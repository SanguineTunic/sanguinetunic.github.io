...
<button type="button" href="https://github.com/SanguineTunic/sanguinetunic.github.io/raw/master/files/SanguinesStartupUtils.exe">Windows</button> <button type="button" href="{{ site.github.tar_url }}">Coming Soon</button>
